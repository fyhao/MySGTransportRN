...
const SearchResultCard = ({item, nearbyBusStopList, navigation}) => {
	if(item.searchItemType == 'busStop') {
		var serviceNoList = [];
		...
		return (<Text>Not supported search Item Type {item.searchItemType}</Text>)
	}
}
